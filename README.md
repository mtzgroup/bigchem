...
- [qccompute](https://github.com/coltonbh/qccompute) - A package for operating quantum chemistry programs using standardized [qcdata](https://qcdata.coltonhicks.com/) data structures. Compatible with `TeraChem`, `psi4`, `QChem`, `NWChem`, `ORCA`, `Molpro`, `geomeTRIC` and many more. [Documentation](https://qccompute.coltonhicks.com/)
...
### Accessing results ###
# Check results
print("Results: ", output.data) # All structured results from the calculation
...
output = ProgramOutput.open("output.json")
```
